...
import UpdateCard from "./Comps/UpdateCard";
...
function Updates() {
  ...
  return (
    <>
      <div className="container my-3 flex flex-col sm:flex-row flex-wrap justify-center">
        <div className="border dark:border-0 m-2 p-4 rounded w-full sm:w-full md:w-1/2 ">
        ...
        <div className="border m-2 p-4 rounded w-full dark:border-0 sm:w-full md:w-1/3">
