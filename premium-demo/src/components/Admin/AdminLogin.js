...
function AdminLogin() {
  ...
  return (
    <div className="container mx-auto w-full sm:w-1/3 mt-20">
      <div className="container mx-auto flex jusitfy-center px-4 my-5">
        ...
        <span class="inline-flex px-2 text-gray-700">{msg}</span>
        </div>
      ) : (
        ""
      )} */}
